...
&=r^2 \int_0^{2\pi} \sqrt{1-2\cos\theta+\cos^2\theta + \sin^2\theta} \ d\theta \\
&=r^2 \int_0^{2\pi} \sqrt{2(1-\cos\theta)} \ d\theta \\
&=r^2 \int_0^{2\pi} \sqrt{4\sin^2\frac{\theta}{2}} \ d\theta \\
&=2r^2 \int_0^{2\pi} \sin\frac{\theta}{2}
\end{align*}$$
